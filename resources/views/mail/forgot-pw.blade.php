...
<div style="background-color:deepskyblue;margin-bottom:20px;height:50px;">
    <h2 style=" color: white; margin-left: 20px; line-height: 50px;"> Verify Your Email Address </h2>
</div>

<div style="display: block !important;">
    <div style="padding-bottom: 20px;">
        <span> Thanks for verifying your {{ $email }} account! </span>
    </div>
    <div style="padding-bottom: 20px;">
        <span style="font-weight: bold; font-size: large;"> Your code is: {{ $code }} </span>
    </div>
    <div style="padding-bottom: 20px;">
        <span> Sincerely. </span>
    </div>
